...
public class CycleRouteSearchService extends IntentService {
    ...
    /**
     * Handle action cycle route search in the provided background thread with the provided
     * parameters.
     */
    private void handleCycleRouteSearchAction(String urlParam) {
        ApiCalls apiCalls = new ApiCalls();
        String cycleRoutesJsonString = apiCalls.performApiCall(urlParam);

        ArrayList<Route> routes = getCycleRoutesFromJson(cycleRoutesJsonString);
